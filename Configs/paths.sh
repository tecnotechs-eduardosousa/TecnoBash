...
SITAG_ADAPT_PATH="$HOME/Desenvolvimento/SITAG/adapt"
SITAG_SERVICOS_PATH="$HOME/Desenvolvimento/SITAG/servicos"
SITAG_EXTRAS_PATH="$HOME/Desenvolvimento/SITAG/extras"
